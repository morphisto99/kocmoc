...
mobkill:CreateToggle("Kill Stick Bug", nil, function(State) kocmoc.toggles.killstickbug = State end)
...
task.spawn(function() while task.wait() do
    if kocmoc.toggles.autofarm then
        ...
        if kocmoc.toggles.farmpuffshrooms and game.Workspace.Happenings.Puffshrooms:FindFirstChildOfClass("Model") then
			...
			if api.partwithnamepart("Lvl 12", game.Workspace.Happenings.Puffshrooms):FindFirstChild("Puffball Stem").CFrame then print ("Puffshroom Lvl 12") end
			if api.partwithnamepart("Lvl 13", game.Workspace.Happenings.Puffshrooms):FindFirstChild("Puffball Stem").CFrame then print ("Puffshroom Lvl 13") end
			if api.partwithnamepart("Lvl 14", game.Workspace.Happenings.Puffshrooms):FindFirstChild("Puffball Stem").CFrame then print ("Puffshroom Lvl 14") end
			if api.partwithnamepart("Lvl 15", game.Workspace.Happenings.Puffshrooms):FindFirstChild("Puffball Stem").CFrame then print ("Puffshroom Lvl 15") end
			if api.partwithnamepart("Lvl 16", game.Workspace.Happenings.Puffshrooms):FindFirstChild("Puffball Stem").CFrame then print ("Puffshroom Lvl 16") end
        ...
        elseif tonumber(pollenpercentage) >= tonumber(kocmoc.vars.convertat) then -- when pollen is full
