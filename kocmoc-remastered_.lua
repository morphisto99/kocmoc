...
wayp:CreateDropdown("NPC Teleports", npctable, function(Option) d = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(d.Position.X, d.Position.Y+3, d.Position.Z) end)
