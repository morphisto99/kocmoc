...
wayp:CreateDropdown("NPC Teleports", function() for i,v in pairs(npctable) do  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(d.Position.X, d.Position.Y+3, d.Position.Z) end)
